    ...
    >
      ...
      >
        <button
          ...
          className="flex items-center justify-center w-7 h-7 rounded-md text-muted-foreground hover:bg-accent hover:text-foreground transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
        >
      ...
      >
        <button
          ...
          aria-label="Minimize"
          className="inline-flex items-center justify-center w-11 h-full text-muted-foreground hover:bg-accent hover:text-foreground transition-colors outline-none focus-visible:bg-accent"
        >
          <Minus size={14} />
        </button>
        <button
        ...
        <button
          onClick={handleClose}
          aria-label="Close"
          className="inline-flex items-center justify-center w-11 h-full text-muted-foreground hover:bg-destructive hover:text-white transition-colors outline-none focus-visible:bg-destructive focus-visible:text-white"
        >
          <X size={14} />
        </button>
      </div>
